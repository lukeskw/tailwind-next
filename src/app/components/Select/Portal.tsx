...
export type PortalProps = ComponentProps<typeof Select.Portal>
  ...
  return (
    <Select.Portal>
      <Select.Content
        ...
        side="bottom"
        position="popper"
        className="animate-slideUpAndFade group z-10 w-[var(--radix-select-trigger-width)] overflow-hidden rounded-lg border border-zinc-200 bg-white"
      >
